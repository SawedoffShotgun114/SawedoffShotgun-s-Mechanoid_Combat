...
|-----|--------------|-------------|-----|---------------|-------------------|---------------|----------------|------|------------------|-------------------------------------|
| 刽子手 | 4.5\*150=675 | 400%/50%每秒  | 4.0 | 是的，免疫         | 短程跳跃, 瞬爆烟雾，电荷弹三连发 | 120%/18+27RHA | 40%/9+65.25MPa | 5    | 高级机械族制造 (Tier 3) | 350*钢铁, 350*玻璃钢, 10*零部件, 2*同步信号芯片, 1*高级次生核心 |
...
## FAQ: （常见问题解答）
 ...
 A2: 作者以后也许会优化的。 但现在，他恨不得把464个小时掰成889个小时来用    
